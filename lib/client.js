...
__expose({ buildSlides: buildSlides, slidesFromPlain: slidesFromPlain, plainModelView: plainModelView, runRewrite: runRewrite, REWRITE_MAX_RETRIES: REWRITE_MAX_RETRIES, rewriteTarget: rewriteTarget, rewritePlan: rewritePlan, readPlainDeck: readPlainDeck, writePlainDeck: writePlainDeck, plainStoreKey: plainStoreKey, PLAIN_STORE_KEY: PLAIN_STORE_KEY, PLAIN_STORE_MAX: PLAIN_STORE_MAX, markdownToHtml: markdownToHtml, sanitizeHtml: sanitizeHtml, toolLabel: toolLabel, TOOL_LABELS: TOOL_LABELS, workingLines: workingLines, runningTurnNo: runningTurnNo, targetHint: targetHint, baseName: baseName })
return {
  apply(ctx) {
