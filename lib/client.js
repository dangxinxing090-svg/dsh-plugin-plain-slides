...
.dshdeck-working{margin:0 0 8px;box-sizing:border-box;border:1px solid var(--dsw-alias-border-l1);border-radius:10px;background:var(--dsw-alias-bg-layer-1);padding:5px 6px 5px 12px;display:flex;align-items:center;gap:8px;font-size:13px;line-height:1.5;overflow:hidden}
...
__expose({ buildSlides: buildSlides, slidesFromPlain: slidesFromPlain, markdownToHtml: markdownToHtml, sanitizeHtml: sanitizeHtml, toolLabel: toolLabel, TOOL_LABELS: TOOL_LABELS, workingLines: workingLines, runningTurnNo: runningTurnNo, targetHint: targetHint, baseName: baseName })
return {
  apply(ctx) {
    ...
    function AssistantStepView(props) {
      ...
      // Fail closed when the turn carries no closing marker. An aborted or
      ...
      const isClosing = closingSeq === null
